...
(function () {
  ...
  defaultOptions = {
    ...
    tooltip: {
      ...
      pointFormat:
        '<span style="color:{series.color}">\u25CF</span> {series.name}: <b>{point.y}</b><br/>', // docs
      shadow: true,
      //shape: 'calout',
      //shared: false,
	...
	*/
    ...
    getBBox: function () {
      ...
      if (textStr === '' || numRegex.test(textStr)) {
        cacheKey =
          'num.' +
          textStr.toString().length +
          (styles ? '|' + styles.fontSize + '|' + styles.fontFamily : '');
    ...
    destroy: function () {
      var wrapper = this,
        ...
        parentToClean =
          wrapper.renderer.isSVG && element.nodeName === 'SPAN' && wrapper.parentGroup,
        grandParent,
        key,
        i;
    ...
    alignSetter: function (value) {
      this.element.setAttribute(
        'text-anchor',
        { left: 'start', center: 'middle', right: 'end' }[value],
      );
    },
  ...
  extend(SVGElement.prototype, {
    ...
    setSpanRotation: function (rotation, alignCorrection, baseline) {
      ...
      rotationStyle[cssTransformKey + (isFirefox ? 'Origin' : '-origin')] =
        rotationStyle.transformOrigin = alignCorrection * 100 + '% ' + baseline + 'px';
    ...
    getOffset: function () {
      ...
      axis.axisTitleMargin = pick(
        ...
        labelOffset +
          titleMargin +
          (labelOffset &&
            directionFactor * options.labels[horiz ? 'y' : 'x'] - lineHeightCorrection),
      );
    ...
    drawCrosshair: function (e, point) {
      ...
      if (this.cross) {
        this.cross
          ...
          [animation ? 'animate' : 'attr']({ d: path }, animation);
      } else {
        var attribs = {
            ...
            if (axis.zoomEnabled) {
              var horiz = axis.horiz,
                ...
                selectionMax = axis.toValue(
                  horiz ? selectionLeft + selectionWidth : selectionTop + selectionHeight,
                );
      ...
      var chart = this.chart,
        ...
        setScale = function () {
          if (!singleTouch && mathAbs(touch0Start - touch1Start) > 20) {
            ...
            scale =
              forcedScale || mathAbs(touch0Now - touch1Now) / mathAbs(touch0Start - touch1Start);
          }
      ...
      each(this.chart.series, function (series) {
        ...
        if (
          !pick(
            ...
            !defined(seriesOptions.linkedTo) ? UNDEFINED : false,
            true,
          )
        ) {
          return;
        ...
        allItems = allItems.concat(
          series.legendItems || (seriesOptions.legendType === 'point' ? series.data : series),
        );
      });
      return allItems;
    },
      ...
      if (seriesMarkerOptions.enabled !== false || series._hasPointMarkers) {
        ...
        while (i--) {
          ...
          if (enabled && plotY !== UNDEFINED && !isNaN(plotY) && point.y !== null) {
            // shortcuts
            pointAttr =
              point.pointAttr[point.selected ? SELECT_STATE : NORMAL_STATE] || seriesPointAttr;
            radius = pointAttr.r;
          ...
          if (hasPointSpecificOptions) {
            ...
            if (!seriesOptions.marker) {
              ...
              pointStateOptionsHover.color =
                pointStateOptionsHover.color ||
                (!point.options.color && stateOptionsHover.color) ||
                Color(point.color)
    ...
    render: function (group) {
      ...
      if (this.label) {
        ...
        this.label = this.axis.chart.renderer
          .text(str, null, null, options.useHTML) // dummy positions, actual position updated with setOffset method in columnseries
  ...
  extend(Axis.prototype, {
    ...
    update: function (newOptions, redraw) {
      ...
      newOptions = chart.options[this.coll][this.options.index] = merge(
        this.userOptions,
        newOptions,
      );
  ...
  defaultPlotOptions.scatter = merge(defaultSeriesOptions, {
    ...
    tooltip: {
      headerFormat:
        '<span style="color:{series.color}">\u25CF</span> <span style="font-size: 10px;"> {series.name}</span><br/>', // docs
  ...
  var PiePoint = extendClass(Point, {
    ...
    haloPath: function (size) {
      ...
      return this.series.chart.renderer.symbols.arc(
        chart.plotLeft + shapeArgs.x,
        chart.plotTop + shapeArgs.y,
        shapeArgs.r + size,
        shapeArgs.r + size,
        {
    ...
    translate: function (positions) {
      ...
      var series = this,
        ...
        endAngleRad = (series.endAngleRad =
          (mathPI / 180) * (pick(options.endAngle, startAngle + 360) - 90)),
      ...
      if (!series.hasRendered && pick(options.defer, true)) {
        ...
        addEvent(series, 'afterAnimate', function () {
          series.dataLabelsGroup
            .show()
            [seriesOptions.animation ? 'animate' : 'attr']({ opacity: 1 }, { duration: 200 });
        });
      }
    ...
    var chart = this.chart,
      ...
      visible =
        ...
        (point.series.forceDL ||
          chart.isInsidePlot(plotX, mathRound(plotY), inverted) ||
          (alignTo &&
            chart.isInsidePlot(
              plotX,
  ...
  extend(Point.prototype, {
    ...
    setState: function (state, move) {
      ...
      if (point.graphic) {
        ...
        if (stateMarkerGraphic) {
          stateMarkerGraphic[
            state && chart.isInsidePlot(plotX, plotY, chart.inverted) ? 'show' : 'hide'
          ](); // #2450
        }
      }
      ...
      if (haloOptions && haloOptions.size) {
        if (!halo) {
          series.halo = halo = chart.renderer.path().add(series.seriesGroup);
        }
        halo
          .attr(
            extend(
              {
                fill: Color(point.color || series.color)
                  .setOpacity(haloOptions.opacity)
                  .get(),
              },
