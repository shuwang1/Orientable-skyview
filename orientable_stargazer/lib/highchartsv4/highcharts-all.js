            ...
            ? ((f = this.HCEvents[c] || []),
              h
                ? ((i = HighchartsAdapter.inArray(h, f)),
                  ...
                  this.removeEventListener ? b(this, c, h) : this.attachEvent && d(this, c, h))
                : (a(this, c), (this.HCEvents[c] = [])))
            : (a(this), (this.HCEvents = {}));
        },
  ...
  return {
    init: function (c) {
        ...
        ((this._getStyle = function (b, d) {
          ...
          return b.style[d]
            ...
            : (d === 'opacity' && (d = 'filter'),
              ...
              d === 'filter' &&
                (a = a.replace(/alpha\(opacity=([0-9]+)\)/, function (b, a) {
                  return a / 100;
                })),
              a === '' ? 1 : a);
        }),
          (this.adapterRun = function (b, d) {
            ...
            if (a)
              return (
                (b.style.zoom = 1),
                b[a] - 2 * parseInt(HighchartsAdapter._getStyle(b, 'padding'), 10)
              );
          }));
      ...
      n.prototype = {
        update: function () {
          ...
          var d = this.elem,
            a = d.element;
          b && a
            ? d.attr('d', c.step(b[0], b[1], this.now, this.toD))
            : d.attr
              ? a && d.attr(this.prop, this.now)
              : ((b = {}), (b[this.prop] = this.now + this.unit), Highcharts.css(d, b));
        ...
        step: function (b) {
          ...
          if (e.stopAnimation || (e.attr && !e.element)) a = !1;
            ...
            ((e = c - this.startTime),
              (this.state = e / a.duration),
              (this.pos = a.easing(e, 0, 1, a.duration)),
      ...
      this.animate = function (b, d, a) {
        ...
        if (typeof a !== 'object' || a === null)
          ((e = arguments), (a = { duration: e[2], easing: e[3], complete: e[4] }));
        ...
        for (g in d)
          ((i = new n(b, a, g)),
            (f = null),
            g === 'd'
              ? ((i.paths = c.init(b, b.d, d.d)), (i.toD = d.d), (e = 0), (f = 1))
              : b.attr
                ? (e = b.attr(g))
                : ((e = parseFloat(HighchartsAdapter._getStyle(b, g)) || 0),
                  g !== 'opacity' && (h = 'px')),
            f || (f = parseFloat(d[g])),
            i.custom(e, f, h));
      };
    ...
    fireEvent: function (c, b, d, a) {
      ...
      l.createEvent && (c.dispatchEvent || c.fireEvent)
        ...
        : c.HCExtended === !0 && ((d = d || {}), c.trigger(b, d));
...
(function () {
      ...
      if (f) {
        ...
        h[s]
          ...
          : ((g.id = a = 'highcharts-' + tb++),
            (h[s] = i = d.createElement(f).attr(g).add(d.defs)),
            (i.stops = []),
            p(j, function (a) {
              a[1].indexOf('rgba') === 0
  ...
  ta.prototype = {
                  ...
                  if (l)
                    for (
                      ...
                      (delete a.bBox,
                        ...
                        e.length &&
                          m.appendChild(y.createTextNode(e.join(' ').replace(/- /g, '-'))));
                }
              }
            });
          }));
    ...
    symbol: function (a, b, c, d, e, f) {
      ...
      if (h)
        ((g = this.path(h)),
          q(g, { symbolName: a, x: b, y: c, width: d, height: e }),
          f && q(g, f));
      else if (i.test(a))
        ((k = function (a, b) {
          a.element &&
        ...
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((d = c.xData), d.length))
              ((a.dataMin = C(m(a.dataMin, d[0]), Na(d))),
      ...
      a
        ? ((a = b[g]),
          ...
          a ||
            ...
            (b[g + 'm'] = d =
              c.clipRect(-99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight))),
          this.group.clip(a),
      ...
      p(f, function (d) {
        ...
        f
          ...
          : (a[e] = a.chart.renderer
              .path(b)
              .attr({ fill: m(d[2], ya(d[1]).setOpacity(m(c.fillOpacity, 0.75)).get()), zIndex: 0 })
              .add(a.group));
      });
    },
    ...
    translate: function () {
      ...
      p(a.points, function (c) {
        ...
        M(x) < g &&
          g &&
          ((x = g),
          (t = u(M(t - f) > g ? d - g : f - (e.translate(c.y, 0, 1, 0, 1) <= f ? g : 0))));
        c.barX = q;
        c.pointWidth = h;
...
(function (m, C) {
  ...
  F(K.prototype, {
    init: function (a, b, c) {
      ...
      d.options = a = o(e, a);
      (a = a.background) &&
        s([].concat(L(a)).reverse(), function (a) {
    ...
    N = {
      ...
      getPosition: function (a, b) {
        return this.postTranslate(
          this.isCircular ? this.translate(a) : 0,
          q(this.isCircular ? b : this.translate(a), this.center[2] / 2) - this.offset,
        );
      },
      ...
      getPlotBandPath: function (a, b, c) {
        var d = this.center,
          ...
          f = d[2] / 2,
          g = [q(c.outerRadius, '100%'), c.innerRadius, q(c.thickness, 10)],
          k = /%$/,
          l,
          n = this.isCircular;
        this.options.gridLineInterpolation === 'polygon'
          ? (d = this.getPlotLinePath(a).concat(this.getPlotLinePath(b, !0)))
          : (n || ((g[0] = this.translate(a)), (g[1] = this.translate(b))),
            (g = Q(g, function (a) {
              k.test(a) && (a = (x(a, 10) * f) / 100);
              return a;
            })),
            c.shape === 'circle' || !n
              ? ((a = -Math.PI / 2), (b = Math.PI * 1.5), (l = !0))
              : ((a = e + this.translate(a)), (b = e + this.translate(b))),
            (d = this.chart.renderer.symbols.arc(this.left + d[0], this.top + d[1], g[0], g[0], {
              start: a,
              end: b,
      ...
      getPlotLinePath: function (a, b) {
        var c = this,
          ...
          l;
        c.isCircular
          ? (l = ['M', d[0] + e.plotLeft, d[1] + e.plotTop, 'L', f.x, f.y])
          : c.options.gridLineInterpolation === 'circle'
            ? (a = c.translate(a)) && (l = c.getLinePath(0, a))
            : (s(e.xAxis, function (a) {
                a.pane === c.pane && (g = a);
              }),
              (l = []),
              (a = c.translate(a)),
              (d = g.tickPositions),
              g.autoConnect && (d = d.concat([d[0]])),
  ...
  r(G, 'init', function (a, b, c) {
    ...
    if (d) {
      ...
      (F(this, N),
        (this.defaultRadialOptions = (k = f)
          ? this.defaultRadialXOptions
          : o(this.defaultYAxisOptions, this.defaultRadialYOptions)));
    a.call(this, b, c);
    if (!g && (d || e)) {
      a = this.options;
      if (!b.panes) b.panes = [];
  ...
  r(y, 'getLabelPosition', function (a, b, c, d, e, f, g, k, l) {
    var n = this.axis,
      j = f.y,
      i = f.align,
      h = (((n.translate(this.pos) + n.startAngleRad + Math.PI / 2) / Math.PI) * 180) % 360;
    n.isRadial
      ? ((a = n.getPosition(this.pos, n.center[2] / 2 + q(f.distance, -25))),
        f.rotation === 'auto'
          ? d.attr({ rotation: h })
          : j === null &&
            (j = n.chart.renderer.fontMetrics(d.styles.fontSize).b - d.getBBox().height / 2),
        i === null &&
          ((i = n.isCircular
            ? h > 20 && h < 160
              ? 'left'
        ...
        (a.x += f.x),
        (a.y += j))
      : (a = a.call(this, b, c, d, e, f, g, k, l));
    return a;
  });
  r(y, 'getMarkPath', function (a, b, c, d, e, f, g) {
    var k = this.axis;
    k.isRadial
      ? ((a = k.getPosition(this.pos, k.center[2] / 2 + d)), (b = ['M', b, c, 'L', a.x, a.y]))
      ...
      s(this.points, function (b) {
        ...
        d === null && c === null
          ...
          : c === null
            ...
            : d === null
              ? ((b.plotLow = e), (b.plotHigh = null))
              : ((b.plotLow = e), (b.plotHigh = a.translate(d, 0, 1, 0, 1)));
      });
    },
    getSegmentPath: function (a) {
      var b,
      ...
      if (k)
        (k === !0 && (k = 'left'),
          (g.step = { left: 'right', center: 'center', right: 'left' }[k]));
      c = e.call(this, c);
      g.step = k;
      g = [].concat(a, c);
      c[0] = 'L';
      ...
      if (f.enabled || this._hasPointLabels) {
        for (c = b; c--; )
          ((g = a[c]),
            ...
            (g.below = !1),
            k ? ((f.align = 'left'), (f.x = f.xHigh)) : (f.y = f.yHigh));
        ...
        for (c = b; c--; )
          ((g = a[c]),
            ...
            (g.plotY = g._plotY),
            (g.below = !0),
            k ? ((f.align = 'right'), (f.x = f.xLow)) : (f.y = f.yLow));
        e.drawDataLabels && e.drawDataLabels.apply(this, arguments);
      }
    },
    ...
    translate: function () {
      ...
      s(this.points, function (d) {
        var e = o(b.dial, d.dial),
          ...
          g = (x(q(e.baseLength, 70)) * f) / 100,
          k = (x(q(e.rearLength, 10)) * f) / 100,
          l = e.baseWidth || 3,
          n = e.topWidth || 1,
          j = b.overshoot,
          i = a.startAngleRad + a.translate(d.y, null, null, null, !0);
        j && typeof j === 'number'
          ? ((j = (j / 180) * Math.PI),
            (i = Math.max(a.startAngleRad - j, Math.min(a.endAngleRad + j, i))))
  ...
  p.boxplot = o(p.column, {
    ...
    tooltip: {
      pointFormat:
        '<span style="color:{series.color}">●</span> <b> {series.name}</b><br/>Maximum: {point.high}<br/>Upper quartile: {point.q3}<br/>Median: {point.median}<br/>Lower quartile: {point.q1}<br/>Minimum: {point.low}<br/>',
    },
    whiskerLength: '50%',
    whiskerWidth: 2,
  });
  h.boxplot = u(h.column, {
    ...
    drawPoints: function () {
      ...
      s(b, function (b) {
        ...
        if (b.plotY !== C)
          if (
            ((e = b.pointAttr[b.selected ? 'selected' : '']),
            (w = z.width),
            (t = A(z.x)),
            (v = t + w),
            (x = D(w / 2)),
            (f = A(E ? b.q1Plot : b.lowPlot)),
            (g = A(E ? b.q3Plot : b.lowPlot)),
            (k = A(b.highPlot)),
            (l = A(b.lowPlot)),
            (p.stroke = b.stemColor || c.stemColor || y),
            (p['stroke-width'] = q(b.stemWidth, c.stemWidth, c.lineWidth)),
            ...
            (u['stroke-width'] = q(b.medianWidth, c.medianWidth, c.lineWidth)),
            (u['stroke-linecap'] = 'round'),
            (j = (p['stroke-width'] % 2) / 2),
            (i = t + x + j),
            (m = ['M', i, g, 'L', i, k, 'M', i, f, 'L', i, l]),
            E &&
              ((j = (e['stroke-width'] % 2) / 2),
              (i = A(i) + j),
              (f = A(f) + j),
              (g = A(g) + j),
              (t += j),
              (v += j),
              (I = ['M', t, g, 'L', t, f, 'L', v, f, 'L', v, g, 'L', t, g, 'z'])),
            B &&
              ((j = (o['stroke-width'] % 2) / 2),
              (k += j),
              (l += j),
              (r = ['M', i - x * B, k, 'L', i + x * B, k, 'M', i - x * B, l, 'L', i + x * B, l])),
            (j = (u['stroke-width'] % 2) / 2),
            (n = D(b.medianPlot) + j),
            (J = ['M', t, n, 'L', v, n]),
            h)
          )
            (b.stem.animate({ d: m }),
              B && b.whiskers.animate({ d: r }),
              E && b.box.animate({ d: I }),
              b.medianShape.animate({ d: J }));
          else {
  ...
  h.waterfall = u(h.column, {
    ...
    translate: function () {
      ...
      for (c = 0, b = d.length; c < b; c++) {
        ...
        e.isSum || e.isIntermediateSum
          ? ((f.y = a.translate(n[1], 0, 1)), (f.height = a.translate(n[0], 0, 1) - f.y))
          : (l += g.total);
    ...
    processData: function (a) {
      ...
      for (i = 0; i < e; i++)
        ((j = b[i]),
          ...
          j === 'sum' || d.isSum
            ? (b[i] = k)
            : j === 'intermediateSum' || d.isIntermediateSum
              ? ((b[i] = g), (g = f))
              : ((k += j), (g += j)),
          (l = Math.min(k, l)),
          (n = Math.max(k, n)));
    ...
    getGraphPath: function () {
      ...
      for (g = 1; g < b; g++)
        ((f = a[g].shapeArgs),
          ...
          a[g - 1].y < 0 && ((f[2] += e.height), (f[5] += e.height)),
          (d = d.concat(f)));
      return d;
    },
    getExtremes: w,
  ...
  h.bubble = u(h.scatter, {
    ...
    getRadii: function (a, b, c, d) {
      var e,
        ...
        k = this.zData,
        l = [],
        n = this.options.sizeBy !== 'width';
      for (f = 0, e = k.length; f < e; f++)
        ((g = b - a),
          (g = g > 0 ? (k[f] - a) / (b - a) : 0.5),
          n && g >= 0 && (g = Math.sqrt(g)),
          l.push(v.ceil(c + g * (d - c)) / 2));
      this.radii = l;
    },
    animate: function (a) {
  ...
  M.prototype.beforePadding = function () {
    var a = this,
      ...
      k = this.min,
      l = {},
      n = v.min(c.plotWidth, c.plotHeight),
      j = Number.MAX_VALUE,
      i = -Number.MAX_VALUE,
      h = this.max - k,
      m = b / h,
    ...
    this.tickPositions &&
      (s(this.series, function (b) {
        ...
        if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))
          if (((a.allowZoomOutside = !0), p.push(b), f))
            (s(['minSize', 'maxSize'], function (a) {
              ...
              (b.minPxSize = l.minSize),
              (b = b.zData),
              b.length &&
                ((j = v.min(
                  j,
                  v.max(O(b), g.displayNegative === !1 ? g.zThreshold : -Number.MAX_VALUE),
                )),
                (i = v.max(i, P(b)))));
      }),
      s(p, function (a) {
        ...
        if (h > 0)
          for (; c--; )
            typeof b[c] === 'number' &&
              ((n = a.radii[c]),
              (d = Math.min((b[c] - k) * m - n, d)),
              (e = Math.max((b[c] - k) * m + n, e)));
      }),
      p.length &&
        h > 0 &&
        q(this.options.min, this.userMin) === C &&
        q(this.options.max, this.userMax) === C &&
        ((e -= b), (m *= (b + d - e) / b), (this.min += d / m), (this.max += e / m)));
  };
  (function () {
    function a(a, b, c) {
      a.call(this, b, c);
    ...
    function b(a, b) {
      ...
      if (c.polar) {
        if (c.renderer.isSVG)
          (d === !0 && (d = {}),
            b
              ? ((c = { translateX: i[0] + h, translateY: i[1] + m, scaleX: 0.001, scaleY: 0.001 }),
                e.attr(c),
                j && j.attr(c))
              : ((c = { translateX: h, translateY: m, scaleX: 1, scaleY: 1 }),
                e.animate(c, d),
                j && j.animate(c, d),
                (this.animate = null)));
      } else a.call(this, b);
    ...
    h.spline &&
      r(h.spline.prototype, 'getPointSpline', function (a, b, c, d) {
        var e, j, i, h, m, p, o;
        if (this.chart.polar) {
          e = c.plotX;
          j = c.plotY;
          ...
          if (a && i)
            ((h = a.plotX),
              ...
              (i = (1.5 * e + b) / 2.5),
              (o = (1.5 * j + p) / 2.5),
              (b = Math.sqrt(Math.pow(h - e, 2) + Math.pow(m - j, 2))),
              (p = Math.sqrt(Math.pow(i - e, 2) + Math.pow(o - j, 2))),
              (h = Math.atan2(m - j, h - e)),
              (m = Math.atan2(o - j, i - e)),
              (o = Math.PI / 2 + (h + m) / 2),
              Math.abs(h - o) > Math.PI / 2 && (o -= Math.PI),
              (h = e + Math.cos(o) * b),
              (m = j + Math.sin(o) * b),
              (i = e + Math.cos(Math.PI + o) * p),
              (o = j + Math.sin(Math.PI + o) * p),
              (c.rightContX = i),
              (c.rightContY = o));
          d
            ? ((c = ['C', a.rightContX || a.plotX, a.rightContY || a.plotY, h || e, m || j, e, j]),
      ...
      c.polar
        ? s(c.axes, function (a) {
            ...
            d[e ? 'xAxis' : 'yAxis'].push({
              axis: a,
              value: a.translate(
                e ? Math.PI - Math.atan2(h, f) : Math.sqrt(Math.pow(h, 2) + Math.pow(f, 2)),
                !0,
              ),
            });
          })
...
(function (c) {
  ...
  c.SVGRenderer.prototype.cuboid = function (e) {
    var a = this.g(),
      e = this.cuboidPath(e);
    a.front = this.path(e[0]).attr({ zIndex: e[3], 'stroke-linejoin': 'round' }).add(a);
...
(function (f) {
  ...
  f.post = function (b, a, d) {
    var c,
      b = l(
        'form',
        k({ method: 'post', action: b, enctype: 'multipart/form-data' }, d),
        { display: 'none' },
        j.body,
      );
  ...
  p(A.prototype, {
    ...
    exportChart: function (b, a) {
      var b = b || {},
        ...
        d = this.getSVG(
          k({ chart: { borderRadius: 0 } }, d.chartOptions, a, {
            exporting: {
    ...
    contextMenu: function (b, a, d, c, f, h, g) {
      ...
      c + h + e.exportMenuHeight > n && g.alignOptions.verticalAlign !== 'top'
        ? (a.bottom = n - c - u + 'px')
        : (a.top = c + h - u + 'px');
      v(i, a);
      e.openMenu = !0;
    ...
    addButton: function (b) {
      var a = this,
        ...
        g,
        e,
        l = { stroke: c.symbolStroke, fill: c.symbolFill },
        q = c.symbolSize || 12;
      ...
      if (c.enabled !== !1) {
        ...
        c.text && c.symbol
          ? (m.paddingLeft = f.pick(m.paddingLeft, 25))
          : c.text || p(m, { width: c.width, height: c.height, padding: 0 });
        e = d
          .button(c.text, 0, 0, i, m, o, n)
          .attr({ title: a.options.lang[c._titleKey], 'stroke-linecap': 'round' });
        e.menuClassName = b.menuClassName || 'highcharts-menu-' + a.btnCount++;
        c.symbol &&
          (g = d
            .symbol(c.symbol, c.symbolX - q / 2, c.symbolY - q / 2, q, q)
            .attr(p(l, { 'stroke-width': c.symbolStrokeWidth || 1, zIndex: 1 }))
            .add(e));
  ...
  j.extend(n.prototype, {
    ...
    parseTable: function () {
      ...
      b &&
        ...
        m(b.getElementsByTagName('tr'), function (a, b) {
          b >= d &&
            b <= e &&
            m(a.children, function (a, e) {
      ...
      c &&
        jQuery.ajax({
          ...
          url:
            ...
            c +
            '/' +
            (b.googleSpreadsheetWorksheet || 'od6') +
          ...
          success: function (b) {
            var b = b.feed.entry,
              ...
              l;
            for (l = 0; l < j; l++)
              ((c = b[l]), (m = Math.max(m, c.gs$cell.col)), (n = Math.max(n, c.gs$cell.row)));
            for (l = 0; l < m; l++)
              if (l >= i && l <= g) ((d[l - i] = []), (d[l - i].length = Math.min(n, h - e)));
            for (l = 0; l < j; l++)
              if (
                ((c = b[l]),
                (f = c.gs$cell.row - 1),
    ...
    parseTypes: function () {
      for (var a = this.columns, b = a.length, c, d, e, h; b--; )
        for (c = a[b].length; c--; )
          ((d = a[b][c]),
            (e = parseFloat(d)),
            (h = this.trim(d)),
            h == e
              ? ((a[b][c] = e), e > 31536e6 ? (a[b].isDatetime = !0) : (a[b].isNumeric = !0))
              : ((d = this.parseDate(d)),
                b === 0 && typeof d === 'number' && !isNaN(d)
                  ? ((a[b][c] = d), (a[b].isDatetime = !0))
                  : (a[b][c] = h === '' ? null : h)));
    },
    dateFormats: {
      'YYYY-mm-dd': {
    ...
    parseDate: function (a) {
      ...
      if (typeof a === 'string')
        for (d in this.dateFormats)
          ((b = this.dateFormats[d]), (e = a.match(b.regex)) && (c = b.parser(e)));
      return c;
    },
    ...
    complete: function () {
      ...
      if (d.complete) {
        ...
        a.length > 1 &&
          ((b = a.shift()),
          this.headerRow === 0 && b.shift(),
          b.isDatetime ? (c = 'datetime') : b.isNumeric || (c = 'category'));
        ...
        for (g = 0, k = 0; g < a.length; k++) {
          ...
          if (g + e <= a.length)
            for (f = 0; f < a[g].length; f++)
              ((i[f] = [b[f], a[g][f] !== void 0 ? a[g][f] : null]),
  ...
  j.wrap(j.Chart.prototype, 'init', function (a, b, c) {
    ...
    b && b.data
      ? j.data(
          j.extend(b.data, {
            complete: function (e) {
              b.hasOwnProperty('series') &&
                (typeof b.series === 'object'
                  ? m(b.series, function (a, c) {
